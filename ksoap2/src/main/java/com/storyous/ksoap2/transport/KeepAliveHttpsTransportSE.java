...
public class KeepAliveHttpsTransportSE extends HttpsTransportSE
{
    ...
    /**
     * Get a service connection. Returns an implementation of {@link com.storyous.ksoap2.transport.ServiceConnectionSE} that
     * ignores "Connection: close" request property setting and has "Connection: keep-alive" always set and is uses
     * a https connection.
     * @see com.storyous.ksoap2.transport.HttpTransportSE#getServiceConnection()
     */
    //@Override
